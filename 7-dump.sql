...
--
-- Table structure for table `cities`eee
--
...
--
-- Dumping data for table `cities`yee
--
...
--
-- Table structure for table `states` aa
--
...
--
-- Dumping data for table `states` wa
--
...
-- Dump completed on 2017-03-25 19:42:51 watv
